...
- Set the name and icon
  - ⚠️ Make sure your image has read/write enabled [`Image Import Settings > Advanced > Read/Write`](https://docs.unity3d.com/ScriptReference/Texture-isReadable.html)
